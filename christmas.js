...
alison.wishList.push('Shawl (Triangle)')
alison.wishList.push('Color Street: Tokyo Lights, Bordeaux Glitz, No Way San Jose, Venetian Velvet')
alison.wishList.push('Water Bottle w/ Builtin Filter')
alison.wishList.push('Mini Diffuser')
alison.wishList.push('Gift Card: Pedicure')
alison.wishList.push('Gift Card: Lush')

const declan = users.find(user => user.username == 'sdeclan')
declan.wishList.push('Dressing Frames')
declan.wishList.push('Easel & Paper')
declan.wishList.push('Kid Size Bean Bag or Similar')
declan.wishList.push('3T or 4T Robe')
declan.wishList.push('Books')
declan.wishList.push('Tricycle')
